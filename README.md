...
Run the controlled live teardown missions, capture comparable evidence for each product, and validate the working hypotheses through Zepto-user survey and follow-up evidence.
...
- Survey instrument and adaptive web app: ready.
